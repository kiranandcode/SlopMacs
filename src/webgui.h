/* Web display backend GUI definitions for GNU Emacs.
...
typedef struct web_char_struct
{
  int rbearing;
  int lbearing;
  int width;
...
#define NativeRectangle struct web_rect
...
/* GC-related defines needed by xfaces.c.  */
